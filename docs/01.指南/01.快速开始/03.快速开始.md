...
推荐下载地址：[点击去官网](https://www.metaquotes.net/cn/download)，若已安装MT5则跳过此步骤。

若无法访问官网：[点击下载](https://oss.trademonitor.cn/plat/mt5setup.exe)
...
这是我们量化程序的核心交易端：[点击下载](https://oss.trademonitor.cn/expert/Grid_V1.4.1.ex5)
...
在弹出对话框的“输入”栏的“值”这一列填上你的手机号码

![描述](/EA/EA-LOAD-2-2.png)

在弹出对话框的“依存关系”页下勾选“允许DLL导入”

![描述](/EA/EA-LOAD-2-3.png)
...
初次登陆即自动注册，使用注册时填写的手机号配合验证码即可成功登录，注册成功后会收到邮件或短信提示。
...
::: tip 注意：初次使用可联系客服申请7天免费试用会员兑换码
[点击添加企微客服领取](https://work.weixin.qq.com/ca/cawcde6649cebcbe24)
:::
